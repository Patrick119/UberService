    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('oferta', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='UberService.oferta')),
            ],
        ),
        migrations.CreateModel(
            name='Pago',
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('orden_servicio', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='UberService.ordenservicio')),
            ],
        ),
        migrations.CreateModel(
            name='AjusteTarifa',
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('profesion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='UberService.profesion')),
            ],
        ),
        migrations.CreateModel(
            name='Profesional',
        ...
        migrations.AddField(
            model_name='oferta',
            name='profesional',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='UberService.profesional'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('profesional', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='UberService.profesional')),
            ],
        ),
        migrations.CreateModel(
            name='Puntos',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('profesional', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='UberService.profesional')),
            ],
        ),
        migrations.CreateModel(
            name='Servicio',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('servicio_gratuito', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='UberService.servicio')),
            ],
        ),
        migrations.CreateModel(
            name='ImagenServicio',
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('servicio', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='UberService.servicio')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='UberService.solicitudservicio'),
        ),
        migrations.AddField(
            model_name='oferta',
            name='solicitud_servicio',
